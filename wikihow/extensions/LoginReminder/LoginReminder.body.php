	...
	function displayForm($template) {
		...
		<form name="userlogin" method="post" action="#" onSubmit="return checkSubmit('wpName2', 'wpCaptchaWord', 'wpCaptchaId');">
			...
			<table>
				...
				<tr>
					<td class="mw-label" style="vertical-align:bottom;"><label style="display:block; padding-bottom: 35px"><?=wfMsg('lr_security_label')?></label></td>
					<td class="mw-input">
						<div style="position:relative">
				...
				<tr>
					...
					<td style="padding-top:5px">
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td>
								<input type="submit" value="<?=wfMsg('lr_reset_password_label');?>" id="wpMailmypassword" onmouseout='button_unswap(this);' onmouseover='button_swap(this);' class="button button150 submit_button" name="wpMailmypassword" onmouseover="button_swap(this);" onmouseout="button_unswap(this);" >
								</td>
								<td>
