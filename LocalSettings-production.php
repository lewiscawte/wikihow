...
require_once("$IP/extensions/wikihow/AdminEditMetaInfo.php");
...
# If http X-Initial-URL header is set and comes from pad*, it's a CDN request
$wgIsCDNRequest = strpos(@$_SERVER['HTTP_X_INITIAL_URL'], 'http://pad') === 0;
