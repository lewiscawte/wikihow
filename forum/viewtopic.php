 ...
 *
 *   $Id: viewtopic.php,v 1.3 2007/10/12 14:43:43 cvsuser Exp $
 *
 *
 ***************************************************************************/
...
//
$sql = "SELECT u.user_name, u.user_real_name, u.user_id, u.user_options, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid
...
for($i = 0; $i < $total_posts; $i++)
{
	...
	$poster = ( $poster_id == ANONYMOUS ) ? $lang['Guest'] : $postrow[$i]['user_name'];
	if ($postrow[$i]['user_real_name'] != "") {
		$poster = $postrow[$i]['user_real_name'];
	}
	if ($poster_id != ANONYMOUS) {
		$poster = "<a href=\"http://www.wikihow.com/User:" .  $postrow[$i]['user_name']
			. "\">$poster</a>";
	}
	...
	if ( $poster_id != ANONYMOUS )
	{
		$temp_url = "$wikiBase/User:" . $postrow[$i]['user_name'];
		$profile_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_profile'] . '" alt="' . $lang['Read_profile'] . '" title="' . $lang['Read_profile'] . '" border="0" /></a>';
		$profile = '<a href="' . $temp_url . '">' . $lang['Read_profile'] . '</a>';

		$temp_url = "$wikiBase/User_talk:" . $postrow[$i]['user_name'];
		$pm_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_pm'] . '" alt="Visit User\'s Talk Page" title="Visit User\'s Talk Page" border="0" /></a>';
		$pm = '<a href="' . $temp_url . '">' . $lang['Send_private_message'] . '</a>';

		$email_uri = "$wikiBase/Special:Emailuser?target=" . $postrow[$i]['user_name'];
	...
	$temp_url = append_sid("search.$phpEx?search_author=" . urlencode($postrow[$i]['user_name']) . "&amp;showresults=posts");
