 ...
 *
 *   $Id: modcp.php,v 1.3 2007/08/13 18:51:34 cvsuser Exp $
 *
 ***************************************************************************/
...
switch( $mode )
{
	...
	case 'split':
		...
		else
		{
			...
			$sql = "SELECT u.user_name, p.*, pt.post_text, pt.bbcode_uid, pt.post_subject, p.post_username
	...
	case 'ip':
		...
		$template->assign_vars(array(
			...
			'IP' => $ip_this_post . "&nbsp;<a href='/Special:Blockip/$ip_this_post'>Block?</a>&nbsp;",
		...
		//
		$sql = "SELECT u.user_id, u.user_name, COUNT(*) as postings 
	...
	default:
		...
		$sql = "SELECT t.*, u.user_name, u.user_id, p.post_time
