...
// For accesskeys
var is_ff2_win = ((clientPC.indexOf('firefox/2') != -1
		|| clientPC.indexOf('minefield/3') != -1)
	&& clientPC.indexOf('windows') != -1);
var is_ff2_x11 = ((clientPC.indexOf('firefox/2') != -1
		|| clientPC.indexOf('minefield/3') != -1)
...
$(document).ready(function(){
	...
	//Slider
	//not for browsers that don't render +1 buttons
	if ($('#slideshowdetect').length && slider && !getCookie('sliderbox') && isiPhone < 0 && isiPad < 0 && !is_ie6 && !is_ie7) {
