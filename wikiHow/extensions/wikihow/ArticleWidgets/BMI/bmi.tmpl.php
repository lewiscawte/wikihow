...
<link media="screen" href="/extensions/wikihow/ArticleWidgets/BMI/css/style.css?rev=<?=WH_SITEREV?>" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.6.4/jquery.min.js"></script>
<script type="text/javascript" src="/extensions/wikihow/ArticleWidgets/BMI/js/script.js?rev=<?=WH_SITEREV?>"></script>
</head>
<body scroll="no" style="overflow:hidden;">
<div id="wrapper">
  <div id="header"> <img src="/extensions/wikihow/ArticleWidgets/BMI/images/corner_left_green.png" width="11" height="10" alt="" class="corner_left" /> <img src="/extensions/wikihow/ArticleWidgets/BMI/images/corner_right_green.png" width="11" height="10" alt="" class="corner_right" />
    <ul class="tabs">
      <li><a href="#tab1">
        <p>Imperial</p>
        </a></li>
