...
class NewLayout extends UnlistedSpecialPage {
	...
	public function displayHtml() {
		...
		$css = '/extensions/min/f/skins/WikiHow/new.css,/extensions/wikihow/common/jquery-ui-themes/jquery-ui.css,extensions/wikihow/NewLayout/NewLayout.css';
		...
		$wgOut->addHTML($this->parseArticle($article));
...
//		$fb_share = '<div class="like_button like_tools"><fb:like href="' . $url . '" send="false" layout="button_count" width="86" show_faces="false"></fb:like></div>';
		...
		$article = '<div id="article_layout_01">'.$sidebar.$main.'</div>';
