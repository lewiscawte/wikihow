...
WH.wikihowAds = (function ($) {
	...
	var adsSet = false,
		...
		adIndex = 0,
		adUnitArray = {},
		adCount = {'intro':1, '0':1, '1':3, '2':3, '2a':3, '5':1, '7':2};
	...
	function setupAd(adId) {
		...
		if(adIndex < adArray.length) {
			...
			for(i = 0; i < adCount[adId]; i++) {
				...
				if(ad != undefined) {
					s += '<div class="ad1"' + adText + '>'+ '<h4><a href="' + ad.url + '"' + adTitle + ' target="_blank">'
					+ ad.line1 + '</a></h4> '
					+ ad.line2 + ' ' + ad.line3 + '<br />' +
					'<a href="' + ad.url + '" ' + adUrl + ' target="_blank">' + ad.visible_url + '</a></div>';
				}
			}
