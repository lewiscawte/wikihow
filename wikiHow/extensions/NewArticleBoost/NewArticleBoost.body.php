	...
	private function displayNABList(&$dbw, &$dbr) {
		...
		while ($row = $dbr->fetchObject($res)) {
			...
			if ($row->st_title != null) {
				$wgOut->addHTML("<img src='" . wfGetPad('/extensions/wikihow/CheckMark.png') . "' height='16' width='16' alt='suggestion'/>");
			}
			$wgOut->addHTML("</td><td>");
...
class Copyrightchecker extends UnlistedSpecialPage {
	...
	public function __construct() {
		UnlistedSpecialPage::UnlistedSpecialPage('Copyrightchecker', '', false, true);
	}
...
class Markrelated extends UnlistedSpecialPage {
	...
	public function __construct() {
		UnlistedSpecialPage::UnlistedSpecialPage('Markrelated', '', false, true);
	}
...
class NABClean extends UnlistedSpecialPage {
	...
	public function __construct() {
		UnlistedSpecialPage::UnlistedSpecialPage('NABClean', '', false, true);
	}
