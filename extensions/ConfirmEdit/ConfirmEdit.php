...
$wgCaptchaTriggersOnNamespace[NS_USER_TALK]['edit'] = true;
$wgCaptchaTriggersOnNamespace[NS_TALK]['create'] = true;
$wgCaptchaTriggersOnNamespace[NS_USER_TALK]['create'] = true;
...
$wgCaptchaStorageClass = 'CaptchaCacheStore'; //CaptchaSessionStore';
...
if ( defined( 'MW_SUPPORTS_EDITFILTERMERGED' ) ) {
	$wgHooks['EditFilterMerged'][] = array('ConfirmEditHooks::confirmEditMerged');
} else {
...
$wgHooks['AbortAccountReminder'][] = 'ConfirmEditHooks::confirmAccountReminder';
$wgHooks['AccountReminderNewCaptcha'][] = 'ConfirmEditHooks::injectUserCreate';
# Register API hook
