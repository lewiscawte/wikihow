...
class SpecialOpenIDLogin extends SpecialOpenID {
	...
	function loginForm() {
		...
		$wgOut->addHTML(
			...
			Xml::openElement( 'fieldset', array(), wfMsg( 'openidsigninorcreateaccount' ) ) .
			$largeButtonsHTML .
	...
	function chooseNameForm( $openid, $sreg, $ax, $messagekey = null ) {
		...
		$wgOut->addHTML(
			...
			Xml::openElement( 'fieldset', array(), wfMsg( 'openidchooselegend' ), false, array( 'id' => 'mw-openid-choosename' ) ) . "\n" .
