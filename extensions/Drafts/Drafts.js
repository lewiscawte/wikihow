...
wgAjaxSaveDraft.buildWikiHowResponseHandler = function() {
...
wgAjaxSaveDraft.save_guided = function() {
	...
	var url = "http://" + window.location.hostname + "/Special:BuildWikiHow";
    wgAjaxSaveDraft.request.open('POST', url, false);
    //wgAjaxSaveDraft.request.onreadystatechange = wgAjaxSaveDraft.buildWikiHowResponseHandler;	
