    ...
    function __construct() {
	 ...
	 function getForm($new_window = false, $title = null, $return_result = false) {
	   ...
	   $result = "<div id='postcomment_newmsg_$id'></div>
			...
			<div id='postcomment_progress_$id' style='display:none;'><center><img src='/extensions/Postcomment/upload.gif'></center></div>
			<table> ";
		...
		$result .= "<input name=\"target\" type=\"hidden\" value=\"" . htmlspecialchars($title->getPrefixedDBkey()) . "\"/>
	        <tr><td valign=\"top\">
	        <a name=\"postcomment\"></a>
	        <a name=\"post\"></a>
	        <b>$msg:</b><br/><br/></td></tr>
	        <tr>
			<td><textarea style='width:500px' tabindex='3' rows='15' cols='100' name=\"comment_text_$id\" id=\"comment_text_$id\"></TEXTAREA></td>
	        <tr><td>
