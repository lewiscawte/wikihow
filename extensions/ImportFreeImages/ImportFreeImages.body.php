...
//  $_SERVER["HTTP_REFERER"]; -- javascript.back wasn't working for some reason... hmph.
	...
	*/
			$filename = trim(urldecode($wgRequest->getVal('ititle'))) . ($wgIFI_AppendRandomNumber ? "-" . rand(0, 9999) : "");
		...
		<script type=\"text/javascript\">
			...
			if ($wgIFI_UseAjax) {	
				...
				$wgOut->addHTML("<br/><br/>" . wfMsg('importfreeimages_results', $wgIFI_AjaxDomain) . "
				   ...
				   <script src='/extensions/ImportFreeImages/importfreeimages.js' type='text/javascript'></script>
