...
<head>  
    ...
    <style type='text/css' media='screen,projection'>/*<![CDATA[*/ @import 'http://www.wikihow.com/skins/WikiHow/main.css'; /*]]>*/</style>
    ...
    <script type='text/javascript' src='/skins/WikiHow/gaWHTracker.js'></script>
...
<img src='/extensions/UploadPopup/uploadcamera.gif' width='100' height='104' id='uploadcamera' />");
		UploadForm::execute();
		// finish off the HTML
...
class UploadPopup extends UnlistedSpecialPage {
    ...
    function __construct() {
        ...
        UnlistedSpecialPage::UnlistedSpecialPage( 'UploadPopup' );
    }
