...
$wgExtensionCredits[NamespaceManagers::thisType][] = array(
        ...
        'version'              => NamespaceManagers::getRevisionId( '$Id: NamespaceManager.php,v 1.1.1.1 2009/11/04 00:04:43 vu Exp $'),
...
/*
 * KalturaCustomEditor is a proprietary hook for those who don't want to use the standard 'CustomEditor' one but still
 * want our article edit. This hook muset be called.
 * called from Wiki.php
*/
		$wgHooks['KalturaCustomEditor'][]				= 'NamespaceManagers::hCustomEditor';
	 ...
	 */
	public static function hSpecialVersionExtensionTypes( &$sp, &$extensionTypes )
	{
	 ...
	 */
	public static function hCustomEditor( $article, $user )
	{
...
*/
	...
	static function getRevisionId( $svnId=null )
	{
		...
		// e.g. $Id: NamespaceManager.php,v 1.1.1.1 2009/11/04 00:04:43 vu Exp $
		$data = explode( ' ', $svnId );
		return $data[2];
	}
...
'SkinTemplateSetupPageCss',
'SkinTemplatePreventOtherActiveTabs',
"EditSectionLink",  // added to manipulate the "Edit" in the video article page
);
