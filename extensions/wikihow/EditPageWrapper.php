...
//		}
		...
		$vid_alt = "";
		$video_msg = "";
		$video_button ="<a id='gatVideoImportEdit' type='button' onclick=\"changeVideo('". urlencode($wgTitle->getDBKey()) . "'); jQuery('#winpop_outer')[0].style.position = 'absolute'; window.scroll(0,0); return false;\" href='#' id='show_preview_button' class='button white_button_150' onmouseover='button_swap(this);' onmouseout='button_unswap(this);' >" . wfMsg('video_change') . "</a>";
		if ($wgUser->getID() == 0) {
