...
<style type='text/css' media='all'>/*<![CDATA[*/ @import '" . wfGetPad('/extensions/min/?b=extensions/wikihow&f=expandtextarea.css,editpagewrapper.css,winpop.css,importvideo.css&rev=') . WH_SITEREV . "'; /*]]>*/</style>
	<div id='introduction'>
	...
	<div id='steps'>
		...
		<a href='#' class='button white_button_200 add_image_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' onclick='easyImageUpload.doEIUModal(\"steps\", 0); return false;'><img src='" . wfGetPad('/skins/WikiHow/images/upload_image.png') . "'/>".wfMsg('eiu-add-image-to-steps')."</a><br />
	...
	<div id='thingsyoullneed' class='{$things_vis}'>
		...
		<a href='#' class='button white_button_200 add_image_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' onclick='easyImageUpload.doEIUModal(\"thingsyoullneed\"); return false;'><img src='" . wfGetPad('/skins/WikiHow/images/upload_image.png') . "'/>".wfMsg('eiu-add-image-to-thingsyoullneed')."</a><br />
