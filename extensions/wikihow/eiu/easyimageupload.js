...
EasyImageUpload.prototype.insertImage = function (src, imgID) {
	...
	// if we are using the intro image adder, increment the stats
	$("#iia_stats_today_images_added, #iia_stats_week_images_added, #iia_stats_all_images_added").each(function(index, elem) {
			$(this).fadeOut();
