<?
class Facebook extends UnlistedSpecialPage {

    function __construct() {
        UnlistedSpecialPage::UnlistedSpecialPage( 'Facebook' );
    }
	...
	function execute( $par ) {
		...
		require_once("facebook/appinclude.php");
		...
		if ($target == 'invite') {
	            ...
	            $code.='<form id="inviteFriends" name="inviteFriends" method="post" action="http://www.wikihow.com/Special:Facebook?target=recordInvites">';
	            $friendList='';
