...
class Videoadder extends SpecialPage {
	...
	function setSideWidgets() {
		...
		$w = "<div class='iia_stats'><h3>" . wfMsg('va_yourstats'). "</h3>
			<table id='va_stats'>
				<tr><td><a href='/Special:Leaderboard/videos_reviewed'>" . wfMsg('va_today') . "</a></td><td class='va_stat'><span id='vastats_today'>" . $today . "</span></td></tr>
				<tr><td><a href='/Special:Leaderboard/videos_reviewed?period=7'>" . wfMsg('va_week') . "</td><td class='va_stat'><span id='vastats_week'>" . $week. "</span></td></tr>
				<tr><td><a href='/Special:Leaderboard/videos_reviewed'>" . wfMsg('va_total') . "</a></td><td class='va_stat'><span id='vastats_total'>" . $week. "</span></td></tr>
				<tr><td><a href='/Special:Leaderboard/videos_reviewed?period=7'>" . wfMsg('va_rank') . "</a></td><td class='va_stat'><span id='vastats_total'>" . self::getRankThisWeek() . "</span></td></tr>
			</table></div>";
		$sk->addWidget($w);
    ...
    function execute ($par) {
		...
		if ($target == 'getnext') {
			...
			$wgOut->addHTML("<div id='va_title'><a href='#' onclick='va_skip(); return false;' class='button white_button_100 ' style='float:right;' onmouseover='button_swap(this);' onmouseout='button_unswap(this);'>Skip</a><span>Article: </span><a href='{$title->getFullURL()}' target='new'>" .  wfMsg("howto", $title->getText()) . "</a></div>
							<div id='va_more' class='off'></div><a href='#' id='va_introlink'>View article introduction</a>
