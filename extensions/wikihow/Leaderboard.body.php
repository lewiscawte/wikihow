...
class Leaderboard extends SpecialPage {
	...
	function getTabs($section, $tab) {
			...
			if ($section == 'Writing') {
				...
				$tabs = " <ul> <li><a href='/Special:Leaderboard/articles_written' $tab1 >Articles Written</a></li> <li><a href='/Special:Leaderboard/risingstars_received' $tab2 >Rising Stars</a></li> <li><a href='/Special:Leaderboard/requested_topics' $tab3>Requests</a></li> <li><a href='/Special:Leaderboard/spellchecked' $tab4 >Spell Checked</a></li></ul>";
				return $tabs;
