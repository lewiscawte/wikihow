...
class Leaderboard extends SpecialPage {
	...
	function getTabs($section, $tab) {
			...
			if ($section == 'Writing') {
				...
				$tabs = " <ul> <li><a href='/Special:Leaderboard/total_edits' $tab1 >Total Edits</a></li> <li><a href='/Special:Leaderboard/articles_categorized' $tab2 >Categorization</a></li> <li><a href='/Special:Leaderboard/images_added' $tab3 >Images Added</a></li> <li><a href='/Special:Leaderboard/videos_reviewed' $tab4 >Videos Reviewed</a></li> </ul>";
				return $tabs;
			}
		return '';
	}
...
*/
	...
	function getVideosReviewed($starttimestamp, $lb_user = '', $getArticles = false) {
		...
		$sql = "SELECT va_user, va_user_text, count(*) as C ".
			"FROM videoadder ".
			"WHERE va_timestamp >= '$starttimestamp' ".
