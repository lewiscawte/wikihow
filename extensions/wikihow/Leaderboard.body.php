...
class Leaderboard extends SpecialPage {
	...
	function getTabs($section, $tab) {
			...
			if ($section == 'Writing') {
				...
				$tab6 = $tab=='repair_stub' ? "class='on'" : "";

				$tabs = " <ul> <li><a href='/Special:Leaderboard/total_edits' $tab1 >All Edits</a></li> <li><a href='/Special:Leaderboard/articles_categorized' $tab2 >Categorization</a></li> <li><a href='/Special:Leaderboard/images_added' $tab3 >Images Added</a></li> <li><a href='/Special:Leaderboard/videos_reviewed' $tab4 >Videos Reviewed</a></li> <li><a href='/Special:Leaderboard/repair_format' $tab5 >Formatting</a></li> <li><a href='/Special:Leaderboard/repair_stub' $tab6 >Stubs</a></li></ul>";
				return $tabs;
			}
		return '';
	}
