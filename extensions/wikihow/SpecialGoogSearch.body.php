...
class GoogSearch extends SpecialPage {
 ...
 <style type='text/css' media='all'>/*<![CDATA[*/ @import '" . wfGetPad('/extensions/min/?b=skins/WikiHow&f=new.css,scott.css,bebeth.css&rev=') . WH_SITEREV . "'; /*]]>*/</style>
 <script type='text/javascript' src='" . wfGetPad('/skins/WikiHow/google_cse_search_box.js?') . WH_SITEREV . "'></script>
</head>
