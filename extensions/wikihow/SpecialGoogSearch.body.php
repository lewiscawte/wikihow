...
class GoogSearch extends SpecialPage {
	...
	function getSearchBox($formid, $q = '', $size = 30) {
		...
		$search_box = wfMsg('cse_search_box_new', $wgServer, $formid, $size, htmlspecialchars($q), $wgLanguageCode);
 ...
 <style type='text/css' media='all'>/*<![CDATA[*/ @import '/skins/WikiHow/scott.css'; /*]]>*/</style>
 <style type='text/css' media='all'>/*<![CDATA[*/ @import '/skins/WikiHow/bebeth.css'; /*]]>*/</style>
 <script type='text/javascript' src='/skins/WikiHow/google_cse_search_box.js'></script>
</head>

<body>
<div id='header'>
    <div id='logo'>
		<a href='{$wgServer}/Main-Page'  class='imglink'>
		<img src='/skins/WikiHow/images/wikihow.png' id='wikiHow' alt='wikiHow - The How-to Manual That You Can Edit' width='216' height='37'/><p>the how to manual that you can edit</p></a>
	</div>
</div>
<div id='main'>
<div id='search_page'>
...
");
		...
		$wgOut->addHTML("
			...
			<img src='/skins/WikiHow/images/actions_top.png' width='978' height='14' alt='' style='display:block;' /> 
			<div class='actions' >
			...
			<img src='/skins/WikiHow/images/actions_bottom.png' width='978' height='19' alt='' />
