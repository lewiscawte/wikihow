...
$wgExtensionMessagesFiles['FBConnect'] = dirname(__FILE__) . '/FBConnect.i18n.php';

/**
 * Facebook Connect debug flag -- always check-in as false and make a
 * local edit.
 */
define('FBCONNECT_DEBUG', false);
