...
function wfAddFBConnectScript () {
	global $wgOut, $wgFBConnectAPIkey;
	$wgOut->addScript('<script src="http://static.ak.connect.facebook.com/js/api_lib/v0.4/FeatureLoader.js.php/en_US" type="text/javascript"></script>');
