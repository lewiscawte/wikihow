	...
	$messages['en'] = array(
		...
		'suggest_input_form'	=>
			"<table width='100%' class='request_table'>
				<tr><td class='label'>Topic:</td>
					<td><span class='input_border'><input type='text' name='suggest_topic' id='entry_howto'></div></td>
				</tr>
				<tr>
				...
				<tr>
				    ...
				    <td><input type='checkbox' name='suggest_email_me_check' CHECKED> E-mail me when my how-to is written:<br />
					<span class='input_border' style='margin-top:10px;'><input type='text' name='suggest_email' value='$4' style='width:230px;' class='fancy_entry'></div>
				    </td>
				</tr>
				<tr>
					<td></td>
		...
		'suggsted_list_topics_title'	=> "<h4 style='float:left'>Find a Suggested Topic to Write About</h4><a href='' class='button button100' style='float:right; margin-bottom:20px' onmouseout='button_unswap(this);' onmouseover='button_swap(this);'>Surprise Me</a>",
