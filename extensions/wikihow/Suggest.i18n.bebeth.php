<?
	$messages['en'] = array(
		...
		'suggestedarticles_header' => "<h4>How about writing how to...</h4><a onclick='reloadTopRow();' class='button button100' style='float:right; margin-top:-26px' onmouseout='button_unswap(this);' onmouseover='button_swap(this);'>Surprise Me</a>",
		'suggest_input_form'	=>
		...
		'suggsted_list_topics_title'	=> "<h4 style='float:left'>Find a Suggested Topic to Write About</h4><a href='/Special:RecommendedArticles' class='button button100' style='float:right; margin-bottom:20px' onmouseout='button_unswap(this);' onmouseover='button_swap(this);'>Surprise Me</a>",
