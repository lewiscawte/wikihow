...
<script type='text/javascript'>
 ...
 if (screen.height < 701) {
	 ...
	 <form name='postcommentForm_" . $id . "' method='POST' action='" . $wgServer . "/Special:Postcomment' target='_blank' 
		 ...
		 ".wfMsg('Quicknote_Instructions1')."<br /><br />

		 <input class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button1') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb1 . "')\" style='margin-left:0;' />
		 <input class='button white_button_150 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button2') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb2 . "')\" />
		 <input class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button3') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb3 . "')\" /><br />
		 <br /><br />" .wfMsg('Quicknote_Instructions2') ."<br />

		 <textarea id='comment_text' name='comment_text' cols=40 rows=8 onkeyup='qnCountchars(this);'></textarea>
		 <div id='qnCharcount' ></div>

		 <input tabindex='4' type='submit' value='Post' class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' id='postcommentbutton_" . $id . "' style='font-size: 110%; font-weight:bold; margin-left:0;'/>
		 <input class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='Cancel' onclick='return qnClose();' /><br class='clearall' />
	 </form>
...
<script type='text/javascript'>
 ...
 if (screen.height < 701) {
	 ...
	 <form name='postcommentForm_" . $id . "' method='POST' action='" . $wgServer . "/Special:Postcomment' target='_blank' 
		 ...
		 <input type='button' value='" . wfMsg('Quicknote_Button1') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb1 . "')\" />
		 <input type='button' value='" . wfMsg('Quicknote_Button2') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb2 . "')\" />
		 <input type='button' value='" . wfMsg('Quicknote_Button3') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb3 . "')\" /><br /><br />
		 ...
		 <input tabindex='4' type='submit' value='Post' cl1ass='btn' id='postcommentbutton_" . $id . "' style='font-size: 110%; font-weight:bold'/>
		 <input type='button' value='Cancel' onclick='return qnClose();' />
	 </form> \n";
		return $display;
	}
