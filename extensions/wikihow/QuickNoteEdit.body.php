...
<script type='text/javascript' src='" . wfGetPad('/extensions/min/?b=extensions&f=wikihow/quicknote.js,Postcomment/postcomment.js&rev=') . WH_SITEREV . "'></script> 
...
<script type='text/javascript'>
 ...
 if (screen.height < 701) {
	...
	function display() {
		$display = "
<style type='text/css' media='all'>/*<![CDATA[*/ @import '" . wfGetPad('/extensions/min/?b=extensions/wikihow&f=popupEdit.css,quicknote.css,winpop.css&rev=') . WH_SITEREV . "'; /*]]>*/</style>
<script type='text/javascript' src='" . wfGetPad('/extensions/min/?b=extensions&f=wikihow/popupEdit.js,wikihow/quicknote.js,Postcomment/postcomment.js,wikihow/winpop.js&rev=') . WH_SITEREV . "'></script> 
<script type='text/javascript'>
