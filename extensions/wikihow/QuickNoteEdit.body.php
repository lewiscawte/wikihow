...
<script type='text/javascript'>
 ...
 if (screen.height < 701) {
	 ...
	 <form name='postcommentForm_" . $id . "' method='POST' action='" . $wgServer . "/Special:Postcomment' target='_blank' 
		 ...
		 <input tabindex='1' class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button1') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb1 . "')\" style='margin-left:0;' />
		 <input tabindex='2' class='button white_button_150 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button2') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb2 . "')\" />
		 <input tabindex='3' class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='" . wfMsg('Quicknote_Button3') . "' onclick=\"qnButtons('postcomment_newmsg_" . $id . "', document.postcommentForm_" . $id . ", '" . $tb3 . "')\" /><br />
		 ...
		 <input tabindex='5' type='submit' value='Post' class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' id='postcommentbutton_" . $id . "' style='font-size: 110%; font-weight:bold; margin-left:0;'/>
		 <input tabindex='6' class='button white_button_100 submit_button' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' type='button' value='Cancel' onclick='return qnClose();' /><br class='clearall' />
	 </form>
