...
?>
	...
	<div id='rcwidget_divid'>
		<a class="rc_help" title="<?php echo wfMsg('rc_help');?>" href="/<?= wfMsg('rcchange-patrol-article') ?>"><img src="<?php echo wfGetPad('/skins/WikiHow/images/icon_help_tan.jpg'); ?>"></a>
		<h3><span onclick="location='/Special:Recentchanges';" style="cursor:pointer;"><?= wfMsg('recentchanges');?></span><span class="weather" onclick="location='/index.php?title=Special:Recentchanges&hidepatrolled=1';" style="cursor:pointer;"></span></h3>
