...
$wgHooks["NABMarkPatrolled"][] = "wfNotifyTwitterOnNAB";
...
$wgHooks["NABMarkPatrolled"][] = array("wfMyTwitterNAB");
...
function wfMyTwitterUpload(&$uploadForm) {
	global $wgUser; 
	if ($uploadForm && $uploadForm->mLocalFile && MyTwitter::userHasOption($wgUser, "upload")) {
		$t = $uploadForm->mLocalFile->title;
