...
class Feed extends UnlistedSpecialPage {
    ...
    function __construct() {
        UnlistedSpecialPage::UnlistedSpecialPage( 'Feed' );
    }
    ...
    function execute ($par) {
		...
		$wgOut->addScript('<style type="text/css" media="all">/*<![CDATA[*/ @import "' . wfGetPad('/extensions/min/f/extensions/wikihow/feed.css?rev=') . WH_SITEREV . '"; /*]]>*/</style>');
	...
	public static function generateFeedItem() {
		...
		switch ($x) {
			...
			case 3:
				...
				$count = number_format($count, 0, ".", ","); 
				$msg = "There are $count edits in the QC queue, start patrolling them <a href='/Special:QC'>now.</a>";
				$t = Title::makeTitle(NS_SPECIAL, "QC");
				break;
			case 4: 
