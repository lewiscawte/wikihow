                           ...
                           <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td width="330" class="mainbar" align="left" valign="top">
									<!--
                                    <h2 style="font-family: Arial; font-size: 22px; font-weight: normal; color: #000000; margin: 0; padding: 0;">
										Congratulations! Someone just gave you a thumbs up for doing quality editing on wikiHow:
									</h2>
									-->
									<!--
									<a style="font-family: Arial; font-size: 16px; font-weight: normal; color: #088A4B;" href="$2">How to $2</a><br><br>
									-->
                                    <p style="font-family: Arial; font-size: 16px; font-weight: normal; color: #4c4c4c;  margin: 10px 0 0 0;  padding: 0;">
									Congratulations, $1! Someone just gave you a <a href="http://www.wikihow.com/wikiHow:Thumbs-Up">thumbs up</a> for doing quality editing on wikiHow:
									</p>
                                    <p style="font-family: Arial; font-size: 16px; font-weight: normal; color: #4c4c4c;  margin: 10px 0 0 0;  padding: 0;">
									<br>
									$2
...
-->
                     ...
                     <tr>
                        <td height="80" class="footer" align="center">
							...
							<p><span style="font-size: 70%; color: #BDBDBD;">
								If you would like to stop receiving thumbs up notifications, you can turn them off in your <a href="http://www.wikihow.com/Special:Preferences">preferences</a>.
								<br>
								If you are receiving this email in error, please feel free to contact us at <a href="mailto:support@wikihow.com">support@wikihow.com</a>.
							</span></p>
						</td>
                     </tr>
                  </table>
