		...
		if(!$wgRequest->getVal('st_search') && !$wgRequest->getVal('category')){
			...
			$wgOut->addHTML(
				...
				<table class="categorytopics" cellspacing="0" cellpadding="0">
					<tr>
					<td class="categorylink"><a href="' . $link . '?category=Arts and Entertainment"><img src="/skins/WikiHow/images/category_Icon_arts.png" /><br />Arts &amp; Entertainment</a></td>
					<td class="categorylink"><a href="' . $link . '?category=' . urlencode('Cars & Other Vehicles') .'"><img src="/skins/WikiHow/images/category_icon_cars.png" /><br />Cars &amp; Other Vehicles</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Computers and Electronics"><img src="/skins/WikiHow/images/category_icon_computers.png" /><br />Computers &amp; Electronics</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Education and Communications"><img src="/skins/WikiHow/images/category_icon_education.png" /><br />Education &amp; Communications</a></td>
					<td class="categorylink last"><a href="' . $link . '?category=Family Life"><img src="/skins/WikiHow/images/category_icon_family.png" /><br />Family Life</a></td>
					</tr>
					<tr>
					<td class="categorylink"><a href="' . $link . '?category=Finance and Business"><img src="/skins/WikiHow/images/category_icon_finance.png" /><br />Finance, Business &amp; Legal</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Food and Entertaining"><img src="/skins/WikiHow/images/category_icon_food.png" /><br />Food &amp; Entertaining</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Health"><img src="/skins/WikiHow/images/category_icon_health.png" /><br />Health</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Hobbies and Crafts"><img src="/skins/WikiHow/images/category_icon_hobbies.png" /><br />Hobbies<br /> &amp; Crafts</a></td>
					<td class="categorylink last"><a href="' . $link . '?category=Home and Garden"><img src="/skins/WikiHow/images/category_icon_home.png" /><br />Home &amp;<br /> Garden</a></td>
					</tr>
					<tr>
					<td class="categorylink"><a href="' . $link . '?category=Holidays and Traditions"><img src="/skins/WikiHow/images/category_icon_holidays.png" /><br />Holidays &amp; Traditions</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Personal Care and Style"><img src="/skins/WikiHow/images/category_icon_personal.png" /><br />Personal<br /> Care &amp; Style</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Pets"><img src="/skins/WikiHow/images/category_icon_pets.png" /><br />Pets &amp;<br /> Animals</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Philosophy and Religion"><img src="/skins/WikiHow/images/category_icon_pholosophy.png" /><br />Philosophy<br /> &amp; Religion</a></td>
					<td class="categorylink last"><a href="' . $link . '?category=Relationships"><img src="/skins/WikiHow/images/category_icon_relationships.png" /><br />Relationships</a></td>
					</tr>
					<tr>
					<td class="categorylink"><a href="' . $link . '?category=Sports and Fitness"><img src="/skins/WikiHow/images/category_icon_sports.png" /><br />Sports &amp;<br /> Fitness</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Travel"><img src="/skins/WikiHow/images/category_icon_travel.png" /><br />Travel</a></td>
					<td class="categorylink"><a href="' . $link . '?category=wikiHow"><img src="/skins/WikiHow/images/category_icon_wikihow.png" /><br />wikiHow</a></td>
					<td class="categorylink"><a href="' . $link . '?category=Work World"><img src="/skins/WikiHow/images/category_icon_work.png" /><br />Work World</a></td>
					<td class="categorylink last"><a href="' . $link . '?category=Youth"><img src="/skins/WikiHow/images/category_icon_youth.png" /><br />Youth</a></td>
					</tr>
				</table>'
...
class RecommendedArticles extends SpecialPage{
	...
	function getTopLevelSuggestions($map, $cats) {
		...
		if ($av == '')
			$av = '<img src="http://pad1.whstatic.com/skins/WikiHow/images/default_profile.png"/>';
		$s .= $av;
		$s .= "
		<p>Requested By<br />";
		if ($userids[0] > 0) {
		...
		if(count($cats) > 0){
			foreach ($cats as $key) {
				...
				if($suggCount > 0){
					...
					$suggestions .= "<tr class='footer'><td colspan='3' style='border:none'><img src='/skins/WikiHow/images/sttable_bottom.png' alt='' /></td></tr>";
					$suggestions .= "</table>";
				}
			}
		}
...
class SuggestCategories extends SpecialPage {

	function __construct() {
        SpecialPage::SpecialPage( 'SuggestCategories' );
    }
    ...
    function execute($par){
		...
		// get top categories
		$wgOut->addHTML("<form method='post' action='/Special:SuggestCategories' id='suggest_cats' name='suggest_cats'><input type='hidden' name='cats' value='" . implode($cats, ",") . "'/>");
		$wgOut->addHTML("<table width='100%' class='categorytopics selecttopics'><tr>");
		$index = 0;
		foreach ($catmap  as $cat) {
			$key = strtolower(str_replace(" ", "-", $cat));
			$safekey = str_replace("&", "and", $key);
			$c = $cats && in_array($key, $cats) ? "chosen" : "not_chosen";
			$s = $cats && in_array($key, $cats) ? "checked='checked'" : "";
			$wgOut->addHTML("<td id='{$safekey}' class='{$c} categorylink'><a class=''><input type='checkbox' id='check_{$safekey}' {$s} />" .  ListRequestedTopics::getCategoryImage($cat) . "<br />{$cat}</a></td>");
			$index++;
			if ($index % 6 == 0)
	    		$wgOut->addHTML("</tr><tr>");
		...
		if($index % 6 <= 5){
			while($index % 6 != 0){
				if($index % 6 == 5){
					$wgOut->addHTML('<td><a onmouseout="button_unswap(this);" onmouseover="button_swap(this);" style="float: right; background-position: 0% 0pt;" class="button button100" onclick="document.suggest_cats.submit();">' . wfMsg('save') . '</a></td>');
			...
			$wgOut->addHTML("</tr></table><br/><br/>" . '<a onmouseout="button_unswap(this);" onmouseover="button_swap(this);" style="float: right; background-position: 0% 0pt;" class="button button100" onclick="document.suggest_cats.submit();">' . wfMsg('save') . '</a></form>');
