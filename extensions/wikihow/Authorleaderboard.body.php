...
class Authorleaderboard extends SpecialPage {
    ...
    function __construct() {
        SpecialPage::SpecialPage( 'Authorleaderboard' );
    }
    ...
    function execute ($par) {
		...
		$wgOut->addHTML(wfMsg('leaderboard_total', number_format($total_newarticles, '', '', ','), $date1, $date2 ) . "<br/><br/><center>");
		...
		/******
 		 ...
 		 *
 		 * ****/
		$wgOut->addHTML(wfMsg('leaderboard_rs_total', number_format($total_risingstar, '', '', ','), $date1, $date2 ) . "<br/><br/><center>");
