...
class FeaturedContributor extends UnlistedSpecialPage {
	...
	function __construct() {
		UnlistedSpecialPage::UnlistedSpecialPage( 'FeaturedContributor' );
	}
...
?>
	<div>
        ...
        <?
            $fc_style = "style='width:150px;'";
		 } 
			else
				$fc_style = "";
		?>
		<span id='fc_id' class='fc_id' onclick='gatTrack("Browsing","Feat_contrib_blurb","Feat_contrib_wgt");' <?php echo $fc_style; ?> ><?php echo $fc_blurb ?></span>
		</div>
