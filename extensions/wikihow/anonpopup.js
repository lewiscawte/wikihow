...
$('#img-box').dialog({
	...
	width: 450,
	open: function () {
		mpmetrics.track('Anon Post Edit OPEN 05');
	},
	close: function() {
		mpmetrics.track('Anon Post Edit CLOSE 05');
	}
});
$('#anonpop-no').click(function() {
	mpmetrics.track('Anon Post Edit No 05');
	$('#img-box').dialog('close');
});
$('#anonpop-start').click(function() {
	mpmetrics.track('Anon Post Edit Start 05','',function() {
