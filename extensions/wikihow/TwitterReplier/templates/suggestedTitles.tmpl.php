...
<?php else: ?>
	<tr>
		<td colspan="2">Search: <?php echo $tweet ?></td>
	</tr>
	<tr>
		<td colspan="2"><?php echo wfMsg( 'no-wh-articles-found' ) ?> <A href="/Special:RequestTopic"><?php echo wfMsg( 'suggest-new-article' ) ?></a></td>
	</tr>
<?php endif ?>
