...
$wgSpecialPages['ListTopicCategories'] = 'ListTopicCategories';
...
$wgAutoloadClasses['ListTopicCategories']   = $dir . 'Suggest.body.php';
$wgAutoloadClasses['YourArticles']	    = $dir . 'Suggest.body.php';
$wgAutoloadClasses['RecommendedArticles'] = $dir . 'Suggest.body.php';

$wgHooks['NABMarkPatrolled'][] = array("wfNotifyRequesterOnNab");
...
function wfNotifyRequesterOnNab($article_id) {
	...
	$dbw->delete('suggested_notify',
            array('sn_page' => $article_id)
        );
