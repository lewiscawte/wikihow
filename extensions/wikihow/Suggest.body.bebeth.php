...
class RecommendedArticles extends SpecialPage{
    ...
    function execute($par){
		...
		$wgOut->addHTML("<div id='top_suggestions_top'>");
		$wgOut->addHTML("<table width='100%' id='top_suggestions' cellspacing='0' cellpadding='0'>");
		$wgOut->addHTML("<tr><td style='width:260px' class='category'>Education &amp; Communications</td>");
		$wgOut->addHTML("<td rowspan='3' class='middle'>OR</td>");
		$wgOut->addHTML("<td style='width:260px' class='category'>Food &amp; Entertaining</td>");
		$wgOut->addHTML("<tr><td class='title'>A short title</td><td class='title'>A long title that spans 2 lines</td></tr>");
		$wgOut->addHTML("<tr><td class='requestor'>");
		$wgOut->addHTML("<img src='/images/avatarOut/1435876.jpg'>");
		$wgOut->addHTML("<p>Requested By<br /><a href='#'>Horsewhips</a></p>");
		$wgOut->addHTML("<a href='#' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' class='button button52'>Write</a>");
		$wgOut->addHTML("<td class='requestor'>");
		$wgOut->addHTML("<img src='/images/avatarOut/1431115.jpg'>");
		$wgOut->addHTML("<p>Requested By<br /><a href='#'>SamSunflower</a></p>");
		$wgOut->addHTML("<a href='#' onmouseout='button_unswap(this);' onmouseover='button_swap(this);' class='button button52'>Write</a>");
		$wgOut->addHTML("</td></tr>");
		$wgOut->addHTML("</tr></table>");
		$wgOut->addHTML("</div>");

		$wgOut->addHTML("<a href='#' id='tryagain'>Nope, Try Again</a>");

		$wgOut->addHTML("<table width='100%' class='suggested_titles_list' cellspacing='0' cellpadding='0'>");
	    $wgOut->addHTML("<tr class='st_top_row'><td class='st_icon'><img src='" . ListRequestedTopics::getCategoryImage('Travel') . "' alt='Travel' /></td><td class='st_title'><strong>Travel</strong> Topics</td><td>Requested By</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'>Anonymous</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'><a href='#'>username</a></td></tr>");
		$wgOut->addHTML("<tr class='footer'><td colspan='3' style='border:none'><img src='/skins/WikiHow/images/sttable_bottom.png' alt='' /></td></tr>");
		$wgOut->addHTML("</table>");

		$wgOut->addHTML("<table width='100%' class='suggested_titles_list' cellspacing='0' cellpadding='0'>");
	    $wgOut->addHTML("<tr class='st_top_row'><td class='st_icon'><img src='" . ListRequestedTopics::getCategoryImage('Wikihow') . "' alt='Travel' /></td><td class='st_title'><strong>wikiHow</strong> Travel</td><td>Requested By</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'>Anonymous</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'><a href='#'>username</a></td></tr>");
		$wgOut->addHTML("<tr class='footer'><td colspan='3' style='border:none'><img src='/skins/WikiHow/images/sttable_bottom.png' alt='' /></td></tr>");
		$wgOut->addHTML("</table>");
		...
		$wgOut->addHTML("<table width='100%' class='suggested_titles_list' cellspacing='0' cellpadding='0'>");
	    $wgOut->addHTML("<tr class='st_top_row'><td class='st_icon'><img src='" . ListRequestedTopics::getCategoryImage('Family Life') . "' alt='Family Life' /></td><td class='st_title'><strong>Family Life</strong> Topics</td><td>Requested By</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'>Anonymous</td></tr>");
		$wgOut->addHTML("<tr><td class='st_write'><a href='#'>Write</td><td class='st_title'>Article Title</td><td class='st_requestor'><a href='#'>username</a></td></tr>");
		$wgOut->addHTML("<tr class='footer'><td colspan='3' style='border:none'><img src='/skins/WikiHow/images/sttable_bottom.png' alt='' /></td></tr>");
		$wgOut->addHTML("</table>");
...
class YourArticles extends SpecialPage{
    ...
    function execute($par){
	    ...
	    $wgOut->addHTML("<tr class='st_top_row'><td colspan='2' class='your_cat_top'><img src='" . ListRequestedTopics::getCategoryImage('Travel') . "' alt='Travel' /> Travel</td><td class='header_views'>Number of Views</td></tr>");
		$wgOut->addHTML("<tr><td class='article_image'></td>");
		$wgOut->addHTML("<td><h4><a href='#' class='title'>How to repair a thermometer</a></h4>");
		$wgOut->addHTML("<p class='meta_info'>Authored by: <a href='#'>You</a></p>");
		$wgOut->addHTML("<p class='meta_info'>Edits by: <a href='#'>Steve</a>, <a href='#'>Krystle</a> (<a href='#'>see all</a>)</p>");
		$wgOut->addHTML("<p class='meta_info'>Last updated <a href='#'>3 days ago</a></p>");
		$wgOut->addHTML("</td>");
		$wgOut->addHTML("<td class='view_count'>902</td></tr>");
		$wgOut->addHTML("<tr><td class='article_image'></td>");
		$wgOut->addHTML("<td><h4><a href='#' class='title'>How to repair a thermometer</a></h4>");
		$wgOut->addHTML("<p class='meta_info'>Authored by: <a href='#'>You</a></p>");
		$wgOut->addHTML("<p class='meta_info'>Edits by: <a href='#'>Steve</a>, <a href='#'>Krystle</a> (<a href='#'>see all</a>)</p>");
		...
		$wgOut->addHTML("</td>");
		$wgOut->addHTML("<td class='view_count'>902</td></tr>");
		$wgOut->addHTML("<tr class='st_middle_row'><td colspan='2' class='your_cat_top'><img src='" . ListRequestedTopics::getCategoryImage('Wikihow') . "' alt='Wikihow' /> Wikihow</td><td class='header_views'>Number of Views</td></tr>");
		$wgOut->addHTML("<tr><td class='article_image'></td>");
		$wgOut->addHTML("<td><h4><a href='#' class='title'>How to repair a thermometer</a></h4>");
		$wgOut->addHTML("<p class='meta_info'>Authored by: <a href='#'>You</a></p>");
		$wgOut->addHTML("<p class='meta_info'>Edits by: <a href='#'>Steve</a>, <a href='#'>Krystle</a> (<a href='#'>see all</a>)</p>");
