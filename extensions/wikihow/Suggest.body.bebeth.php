...
class ListRequestedTopics extends SpecialPage {
	...
	$search = '<div class="st_search">
		...
		<input type="text" value="' . $searchTerm . '" name="st_search" style="width:209px; float:left; margin-top:4px;" />
	...
	function getTabs($section) {
		...
		$recommended = " class='on' ";
	    } else if ($section == "Articles") {
		$articles = " class='on' ";
	    }
	    $tabs .= "<a href='#' onmousedown='button_click(this);'" . $topic . ">Find a Topic</a>";
	    $tabs .= "<a href='#' onmousedown='button_click(this);'" . $recommended . ">Recommended</a>";
	    $tabs .= "<a href='#' onmousedown='button_click(this);'" . $articles . ">Your Articles</a>";
	    return $tabs;
	}
