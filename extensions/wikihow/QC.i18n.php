<?
	...
	$messages = array();
	$messages['en'] = array(
		"quality_control" => "Quality Control Tool",
		...
		'qc_congrats_2' => "You can try changing the <a href='#' class='qc_options_link'>settings on QC</a> to see if you can find more edits in one of the other QC activities.<br /><br />Alternatively, you could try:<ul><li><a href='wikiHow:IntroImageAdderStartPage'>Using the Image Picker App</a></li><li><a href='Special:ListRequestedTopics'>Answering a request</a></li><li><a href='Special:RCPatrol'>Patrolling recent changes</a>",
		'qcprompt_rcpatrol' => "Should this edit have been patrolled?",
		'qc_editsummary_template' => "Removing the template $1 from the article from the QC tool",
		'qc_editsummary_template_add' => "Adding the template $1 to the article from the QC tool",
		'qc_editsummary_introimage' => "Removing the introduction image from the article from the QC tool",
		'qc_editsummary_video' => "Removing the video from the article from the QC tool",
		'qc_rulestocheck'	=> "Change options",
		'qc_stats_title' => "Your QC Stats",
		'qc_standings_title' => "Top QC'ers - Last 7 Days",
