<?
	...
	$messages['en'] = array(
		...
		'qc_congrats_2' => "You can try changing the <a href='#' class='qc_options_link'>settings on QG</a> to see if you can find more edits in one of the other QG activities.<br /><br />Alternatively, you could try:<ul><li><a href='wikiHow:IntroImageAdderStartPage'>Using the Image Picker App</a></li><li><a href='Special:ListRequestedTopics'>Answering a request</a></li><li><a href='Special:RCPatrol'>Patrolling recent changes</a>",
