...
<div id="h5e-link-dialog" class="h5e-dialog" title="">
	...
	<p>
		...
		<span class="h5e-link-how-to"><?= wfMsg('howto', '') ?></span><input id="h5e-link-article" autocomplete="off" />
	...
	<div class="h5e-bottom-buttons">
		<div class="h5e-link-external-help">
			<a title="<?= strip_tags(wfMsg('h5e-external-link-disallowed')) ?>" href="#"><img src="/skins/WikiHow/images/icon_help.jpg"/></a>
			<a class="h5e-external-link-why" title="<?= strip_tags(wfMsg('h5e-external-link-disallowed')) ?>" href="#"><?= wfMsg('h5e-how-to-add-external-link') ?></a>
		</div>
	...
	<div class="h5e-tb-save-wrapper">
		<div class="h5e-tb-left-wrapper">
			...
			<div>
				...
				<a id="h5e-edit-summary-save" style="float: left; background-position: -341px 0pt;" class="h5e-button button106" href=""><?= wfMsg('h5e-save') ?></a>
			</div>
		</div>
		<div class="h5e-tb-right-wrapper">
			<a href="" title="<?= wfMsg('h5e-cancel') ?>" class="h5e-x h5e-toolbar-cancel"></a>
...
<div id="edit-ref-dialog" class="h5e-dialog" title="<?= wfMsg('h5e-edit-reference') ?>">
	<input class="h5e-input" id="ref-edit" type="text" size="50" autocomplete="off" />
	<div class="h5e-bottom-buttons">
