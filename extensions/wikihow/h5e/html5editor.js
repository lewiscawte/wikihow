...
//console.log('xqq',node, 'ce',isNodeContentEditable(node),currentNode);
	...
	function highlightArticle() {
		...
		$('.article_top').css('background-image','url(/skins/WikiHow/images/module_caps_hl.png)');
		$('.article_bottom').css('background-image','url(/skins/WikiHow/images/module_caps_hl.png)');
		$('#article').css('background-image','url(/skins/WikiHow/images/article_bgs_hl.png)');
		$('#last_question').css('background-image','url(/skins/WikiHow/images/article_bgs_hl.png)');
	...
	function unhighlightArticle() {
		...
		$('.article_top').css('background-image','url(/skins/WikiHow/images/module_caps.png)');
		$('.article_bottom').css('background-image','url(/skins/WikiHow/images/module_caps.png)');
		$('#article').css('background-image','url(/skins/WikiHow/images/article_bgs.png)');
		$('#last_question').css('background-image','url(/skins/WikiHow/images/article_bgs.png)');
