...
class RCTest {
	...
	private function fetchTestInfo($testId = null ) {
		...
		$sql .= " ORDER BY rq_difficulty DESC LIMIT 1";
	...
	*/
	...
	public function debugGradeTest($testId, $response) {
		...
		// See if the response was in the ideal or acceptable responses.  Skip is always an acceptable response
		$correct = false !== array_search($response, $correctIds) || $response == RCTestGrader::RESP_SKIP;
