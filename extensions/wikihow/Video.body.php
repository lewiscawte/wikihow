...
class FiveMinApi extends RelatedVideoApi {
	...
	function execute($t) {
		...
		$url = "http://api.5min.com/videoseed/videos.xml?url=http://www.wikihow.com/{$t->getPrefixedURL()}&sid=102{$cats}";
		$url = "http://api.5min.com/videoseed/videos.xml?url=http://www.wikihow.com/{$t->getPrefixedURL()}&sid=102&num_of_videos=4&restriction=no_html&auto_start=true";
		$this->mContent = $this->getResults($url);
...
class Video extends UnlistedSpecialPage {
    ...
    function execute ($par) {
        ...
        $wgOut->addHTML('<script type="text/javascript">
				...
				<script type="text/javascript" language="javascript" src="/extensions/wikihow/video_display.js"></script>
                            <link rel="stylesheet" href="/extensions/wikihow/video_display.css" type="text/css" />');
...
//xxxx
		...
		$wgOut->addHTML("<table class='video_footer'>
				<tr>
					<td id='flagbutton'><a href='javascript:flagVideo();'><img src='/extensions/wikihow/dialog-warning.png' height='10px'> " 
						. wfMsg('video_flag') . "</a></td>
					<td id='backbutton' style='display: none;'><a href='javascript:back()'>
						<img src='/extensions/wikihow/go-previous.png' height='10px'> ". wfMsg('video_returntoarticle') . "</a></td>
				</table>
			");
...
class ManageFlaggedVideos extends UnlistedSpecialPage {
    ...
    function execute ($par) {
		...
		$this->setHeaders();
		$wgOut->addHTML('<link rel="stylesheet" href="/extensions/wikihow/video_display.css" type="text/css" />');
