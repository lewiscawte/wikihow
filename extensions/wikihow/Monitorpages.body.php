...
class Monitorpages extends UnlistedSpecialPage {
    ...
    function __construct() {
        UnlistedSpecialPage::UnlistedSpecialPage( 'Monitorpages' );
    }
    ...
    function execute ($par) {
		...
		$wgOut->addHTML('  <style type="text/css" media="all">/*<![CDATA[*/ @import "/extensions/wikihow/Monitorpages.css"; /*]]>*/</style>');
	    if (!strlen ($target)) {
