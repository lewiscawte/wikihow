 ...
 */
 ...
 class IheartwikiHow extends UnlistedSpecialPage{
	...
	function getBadge($badgeSize){
		...
		$html .= "<td style='border-right:1px solid #DEDACF; padding-right:15px; vertical-align:top;background-color:#ffffff;'>" . htmlspecialchars("<a href='http://wikihow.com'><img src='http://wikihow.com/Special:IheartwikiHow/" . $badgeSize . "' alt='I &lt;3 wikiHow' style='border:none' /></a>") . "</td>";
		$html .= "</tr>";
