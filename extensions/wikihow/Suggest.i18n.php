<?
	$messages['en'] = array(
		'suggest_header'		=> '<h2>Having trouble finding a how-to article that you need?</h2>',
		'suggest_sub_header'	=> '<p>Fill out the form below, and request that someone in the wikiHow community write the how to for you.</p>',
		'suggest_input_form'	=> 
			"
			<h3>Article Details</h3>
			<table width='100%' class='request_table'>
				<tr><td>Article Request:</td>
					<td>How to <input type='text' name='suggest_topic' style='width: 300px;'></td>
				</tr>
				<tr>
					<td>Category:</td>
				...
				<tr>
					<td valign='top' style='width: 250px;'>Type in the following words that you see here:</td>
					<td>$2 $3</td>
				</tr>
			</table>
			<br/><br/>",
		...
		'suggest_confirmation'	=> "Thank you for your submitted request. If you specified your email, we will notify you when the article is written. 
				<br/><br/>
			If you'd like to check back to see if you article has been started, you can check here: <a href='$1'>How to $2</a>.
				<br/><br/>
			Now would you like to:<br/><br/>
				<a href='/Special:ListRequestedTopics'>View other suggested topics</a><br/><br/>
				<a href='/Special:RequestTopic'>Submit an other suggestion</a><br/><br/>
				<a href='/wikiHow:Community'>Visit our community page</a><br/><br/>
				<a href='/Main-Page'>Return to the homepage</a>
			",
		...
		'suggsted_list_topics_title'	=> "<h2>List Suggested Topics</h2>",
                     ...
                     <tr>
                        <td class="header" align="left">
                           <table width="100%" height="90" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                 <td><img src="http://www.wikihow.com/skins/WikiHow/images/wikihow.png" ></td>
                              </tr>
                           </table>
                        </td>
