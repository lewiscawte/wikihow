...
class ProfileBox extends UnlistedSpecialPage {
	...
	function getStatsDispalay($stats, $username){
		...
		$display .= "<td>" . $stats['thumbs_given'] . " thumbs up given</td>";
		$display .= "</tr><tr>";
		$display .= "<td>" . $stats['thumbs_received'] . " thumbs up received</td>";
...
<script language='javascript'>
	...
	var pbfavs_check = false;
		...
		if ($u->getOption('profilebox_startedEdited') == 1) {
			...
			$display .= "<tfoot><tr><td class='pb-title'><a href='#' id='created_more' onclick='pbShow_articlesCreated(\"more\"); return false;'>View most recent 100 >></a><a href='#' id='created_less' style='display:none;' onClick='pbShow_articlesCreated(); return false;'><< View Less</a></td><td colspan='3' class='pb-view'>&nbsp;</td></tr>";
			...
			$display .= "<tfoot><tr><td class='pb-title'><a href='#' id='edit_more' onclick='pbShow_articlesEdited(\"more\"); return false;'>View most recent 100 >></a><a href='#' id='edit_less' style='display:none;' onclick='pbShow_articlesEdited(); return false;'><< View Less</a></td><td colspan='3' class='pb-view'>&nbsp;</td></tr>";
			$display .= "<tr class='pb-footer'><td style='border:none;' colspan='4'><img alt='' src='" . wfGetPad("/skins/WikiHow/images/sttable_bottom.png") . "' /></td></tr></tfoot>";
			$display .="</table>";
		}
