...
function incQuickEditCount() {
	...
	var numedits = parseInt($('#numedits').html());
	$("#iia_stats_today_rc_quick_edits, #iia_stats_week_rc_quick_edits").each(function(index, elem) {
			$(this).fadeOut();
			var cur = parseInt($(this).html());
			$(this).html(cur + numedits);
			$(this).fadeIn();
		}
	);
}
...
function mp() {
	...
	$("#iia_stats_group, #iia_stats_today_rc_edits, #iia_stats_week_rc_edits, #iia_stats_all_rc_edits").each(function(index, elem) {
			$(this).fadeOut();
			var cur = parseInt($(this).html());
			$(this).html(cur + 1);
			$(this).fadeIn();
...
function updateActivewidget() {
	updateWidget("#iia_individual_table_rc_quick_edits", "QuickEditStandingsIndividual");
	updateWidget("#iia_individual_table_rc_edits", "RCPatrolStandingsIndividual");
	window.setTimeout(updateActivewidget, 1000 * RC_WIDGET_USERSTATS_REFESH);
    return false;

}

function updateLeaderboard() {
	updateWidget("#iia_standings_table", "RCPatrolStandingsGroup");
...
function updateTimers() {
	var ids = new Array("#activecdown", "#stup");
