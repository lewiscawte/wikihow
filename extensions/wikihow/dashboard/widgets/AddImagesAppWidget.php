...
class AddImagesAppWidget extends DashboardWidget {
	...
	public function getStartLink(){
		return "<a href='/Special:IntroImageAdder' class='comdash-start'>Start <img src='" . wfGetPad('/skins/WikiHow/images/actionArrow.png') . "' alt=''></a>";
	}
	...
	public function compileStatsData(&$dbr) {
		$data = array();
		$data['ct'] = number_format(IntroImageAdder::getArticleCount($dbr), 0, "", ",");
