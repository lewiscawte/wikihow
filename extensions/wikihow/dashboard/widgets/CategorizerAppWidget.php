...
class CategorizerAppWidget extends DashboardWidget {
	...
	public function getStartLink($showArrow, $widgetStatus){
		if($widgetStatus == DashboardWidget::WIDGET_ENABLED)
			...
			$link = "<a href='/Special:Userlogin?returnto=Special:Uncategorizedpages' class='comdash-login'>Login";
	...
	public function getCount(&$dbr){
		...
		$sql = "SELECT count(*) as C
			...
			";
		//$sql = "select count(*) from page where page_namespace=0 and page_is_redirect=0 and page_catinfo=0;";
		$res = $dbr->query($sql);
