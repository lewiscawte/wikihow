...
class DashboardData {
	...
	const GLOBAL_STATS_CACHEKEY = 'cd-stats';
	const GLOBAL_STATS_EXPIRES = 300; // 5 minutes
	...
	public function compileStatsData() {
		...
		$wgMemc->set(GLOBAL_STATS_CACHEKEY, $stats);
	}
	...
	public function getStatsData() {
		global $wgMemc;
		return $wgMemc->get(GLOBAL_STATS_CACHEKEY);
	}
...
$row=null;
			...
			if ($cacheWrite) {
				$wgMemc->set($this->userCachekey, $row);
			}
