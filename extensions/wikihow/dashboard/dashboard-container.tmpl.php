...
<div class="comdash-container">
	<div class="comdash-top">
		...
		<div id="comdash-header-info"> <?= $userImage ?>
			<span class="header-line" style="font-size:13px; font-weight:bold;">Thanks <?= $userName ?>! This week you:</span>
			<span class="header-line" style="font-size:12px;">Wrote <span id="header-write"><?= $userCounts['write'] ?></span> articles and <a href="#" id="cd-user-more">more</a></span>
		</div>
		<? endif; ?>
	</div>
