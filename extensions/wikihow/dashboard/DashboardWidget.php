...
abstract class DashboardWidget {
	...
	public function getUserStats(&$dbr){
		$data = array();
		$data['start'] = $this->getStartLink(false);
	 ...
	 */
	protected abstract function getStartLink($showArrow);

	/**
	 * Returns the HTML for just the top part of the widget
	 */
	public function getHeaderHTML(){
		return '<div class="comdash-widget-header">' . $this->getTitle() . $this->getStartLink(true) . '</div>';
	}
	 ...
	 * leaderboard count for this widget. Needs to be
	 * implemented by subclass.
	 */

	public abstract function getUserCountDescription();
	...
	private function getAvatarURL($img) {
		...
		if ($type == 'df') {
			...
			return wfGetPad('/images/avatarOut/' . $param);
		}
	}
