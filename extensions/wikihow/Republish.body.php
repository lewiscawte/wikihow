...
class Republish extends SpecialPage {
	...
	function getRepublishText($t){
		...
		$title = "<a href=\"http://www.wikihow.com/Main-Page\"><img border=\"0\" src=\"http://www.wikihow.com/skins/WikiHow/images/wikihow.png\"></a>\n<h1 style='margin-bottom: 0px;'><a href=\"" . $t->getFullURL() ."\">"  . wfMsg('howto', $t->getText()) . "</a></h1>\n"  . wfMsg('republish_taglinelink', $mp->getFullURL()) . "<br/>";
		if (!$r) return "";
		$text = $r->getText();
	...
	function execute ($par) {
		...
		$wgOut->addHTML(
				"
				<script type='text/javascript' src='/skins/WikiHow/sharetab.js'></script>
				<center>
