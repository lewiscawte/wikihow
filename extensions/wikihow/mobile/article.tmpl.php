	<div id="article">
		...
		<div id="article_top">
			<? if ($thumb): ?>
				<?
					if ($introImageFormat == 'conditional') {
						$className = ($width <= $DEVICE_WIDTH / 2 ? 'vertical' : 'horizontal');
					} else if ($introImageFormat == 'right') {
...
<? $gotFirst = false; foreach( array('ingredients', 'steps', 'thingsyoullneed', 'tips', 'warnings', 'video') as $section): ?>
	<? if (isset($sections[$section]) && ($showOnlyStepsTab || $section == 'steps')): ?>
