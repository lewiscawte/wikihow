...
$cond = " AND (datediff(now(), page_lastchecked) > 7 or page_lastchecked='0000-00-00 00:00:00')";

//check pages at mosonce a week
...
$dbw =& wfGetDB( DB_SLAVE );
	...
	foreach ($titles as $title) {	
		...
		$sql = "INSERT INTO google_indexed (gi_page, gi_is_indexed, gi_position) VALUES 
				...
				", $position );" ;
		$dbw->query($sql);
		$dbw->query("UPDATE page set page_lastchecked=now() where page_id={$title->getArticleID()};");
