...
if ($wgLanguageCode != 'de' && $wgLanguageCode != 'es') {
	die ('language not set');
}

if ($wgLanguageCode == 'de') {
	$wgServer = 'http://de.carrot.wikihow.com';
	$wgProdServer = 'http://de.wikihow.com/';
} elseif ($wgLanguageCode == 'es') {
	$wgServer = 'http://es.carrot.wikihow.com';
...
require_once("$IP/extensions/wikihow/SpecialImagecounter.php");
//INTL: Only enable the following extensions if running the english site
...
// Use a different memcache server for the spanish and german sites with the new skin 
define('WH_MEMCACHED_SERVER_1', '127.0.0.1:11212');
