...
function loadToggles() {
	lists =Array("navigation_list", "editing_list", "my_pages_list");
...
function loadimg(url, credits) {
	jQuery('#img-box').html('<center><img src="' + url + '" width="580px"/><br><br><a href="' + credits + '">Credits</a>');
