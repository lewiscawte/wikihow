...
'Change-an-Image-Background-in-MS-Paint-(Green-Screen)',
'Calculate-the-Volume-of-a-Cube',
'Tell-if-Your-Best-Friend-Is-Lesbian',
'Avoid-High-Fructose-Corn-Syrup',
'Jump-Start-a-Car',
'Construct-a-Small-Septic-System',
'Make-a-Hollow-Book',
'Help-Someone-Overcome-a-Heroin-Addiction',
...
'Speak-Pig-Latin',
'Make-Up-with-Your-Partner-After-a-Fight',
'Smoke-in-Your-House-Without-Your-Parents-Finding-Out',
'Clean-a-Jetted-Bathtub',
'Get-More-Followers-on-Tumblr',
'Kiss-in-a-Variety-of-Ways',
'Ace-a-Test',
'Make-Crockpot-Chicken-Tacos',
'Drift-a-Car',
'Cheer-Someone-Up',
...
'Clean-Your-Retainer',
'Have-a-Moving/Typing-Tab-Bar-on-Your-Tumblr-Profile',
...
'Use-Window-Fans-for-Home-Cooling',
...
'Do-a-Backflip',
'Fix-a-Slow-Toilet',
'Say-Goodbye-in-Several-Different-Languages',
...
'Literally-Rotate-Your-Computer-Screen',
...
'Block-Spam-on-Yahoo!-Mail',
'Wash-Shoes',
'Get-Rid-of-Anger',
'Sharpen-a-Chainsaw',
'Make-Cake-in-a-Mug',
'Become-a-Motivational-Speaker',
'Make-a-Friend-Fall-in-Love-with-You',
'Cure-a-Stye',
...
'Reveal-a-Fake-Facebook-Account',
'Back-up-a-Computer',
...
'Be-Pretty-if-You-Are-Unfortunate-With-Your-Looks',
'Lie',
'Be-a-Classy-Girl',
...
'Wire-an-Amp-to-a-Sub-and-Head-Unit',
'Email-a-Professor',
...
'Lay-a-Ceramic-or-Porcelain-Tile-Floor',
'Write-an-Outline',
...
'Convert-Linksys-WRT54G-to-Be-an-Access-Point',
...
'Develop-a-Strong-High-Singing-Voice',
...
'Make-Sure-That-Your-Dog-Is-Ok-After-Giving-Birth',
'Fake-Symptoms-of-Being-Sick',
'Care-for-Hermit-Crabs',
'Deal-with-Being-in-Prison',
'Write-a-Sonnet',
'Make-a-Note-into-an-Envelope',
'Be-a-Girly-Girl',
'Overcome-Shyness',
'Woo-a-Girl',
'Create-a-Username',
'Keep-Healthy',
'Overcome-Fear',
'Reapply-for-a-Mortgage-After-Bankruptcy',
...
'Look-People-in-the-Eye'
	...
	$showKiwi = 
		$wgTitle->exists() &&
		in_array($wgTitle->getDBkey(),$kiwi_array) &&
		$wgTitle->getNamespace() == NS_MAIN &&
		!$isMainPage &&
		$wgRequest->getVal('oldid') == '' &&
		$wgRequest->getVal('create-new-article') == '' &&
...
<div id="header">
    <div id="logo">
		...
		<?php if ($showKiwi) { ?><img src="<?= wfGetPad('/skins/WikiHow/images/kiwihow.png') ?>" id="kiwi" width="40" height="34" /><? }?>
		...
		<?php if(!$isMainPage && $wgUser->getID() > 0 && in_array('staff', $wgUser->getGroups()) && $wgTitle->getNamespace() == NS_MAIN): ?>
				<div class="sidebox_shell">
					...
					<div class="sidebox" style="padding-top:10px">
						<?php if(class_exists("Pagestats"))
							echo Pagestats::getPagestatData($wgTitle->getArticleID());
						?>
					</div>
					<div class='sidebar_bottom_fold'></div>
				</div>
