...
// Intro image test: script to turn intro and intro images off
if (class_exists('CTALinks') && CTALinks::isArticlePageTarget() && trim(wfMsgForContent('data_analysis_feature')) == "on" && !CTALinks::isLoggedIn()) {
