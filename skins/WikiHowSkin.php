...
<? } // no article tabs for special pages ?>
	   <?php wfRunHooks( 'BeforeTabsLine', array( &$wgOut ) ); ?>
		...
		<? } // Featured articls for main page mpFAs ?>
			...
			<?
			$clicky_test = false;
			if(false && $wgTitle->getNamespace() == NS_MAIN && $wgRequest->getVal('action') != 'edit') {
				if ($sk->isQuickBounceUrl('wp_urls')) {
					$clicky_test = true;
					$this->data['bodytext'] = $sk->addImageStrip($this->data['bodytext']);
				}
			}
			?>
...
<noscript>
<div><a href="http://www.w3counter.com"><img src="https://www.w3counter.com/tracker.php?id=53960" style="border: 0" alt="W3Counter" /></a></div>
</noscript>
...
<noscript>
<div><a href="http://www.w3counter.com"><img src="https://www.w3counter.com/tracker.php?id=54119" style="border: 0" alt="W3Counter" /></a></div>
</noscript>
<!-- End W3Counter Secure Tracking Code-->
<?
}
