...
<script type="text/javascript">
  ...
  // Turning off temporarily. Uncomment lines below for data analysis tracking
...
$clicky_urls = wfMsgForContent('clicky_urls');
$clicky_urls = split("\n", $clicky_urls);
if (false && false !==  array_search("/" . urldecode($wgTitle->getPartialURL()), $clicky_urls)) {
	$clicky_id['www.wikihow.com'] = 66420363;
	$clicky_id['jclean.wikidiy.com'] = 66420374;
	$clicky_id = strpos($wgServer,"jclean.wikidiy.com") !== false ? $clicky_id['jclean.wikidiy.com'] : $clicky_id['www.wikihow.com'];
?>
<script type="text/javascript">
var clicky_site_id = <?=$clicky_id?>;
(function() {
...
<noscript><p><img alt="Clicky" width="1" height="1" src="//in.getclicky.com/66420363ns.gif" /></p></noscript>
<?
}
?>
