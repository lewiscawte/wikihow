...
class RecentChange
{
	 ...
	 * @return RecentChange
	 * XXCHANGED -- allow a $fromMaster flag to force pulling this row
	 * from the master DB in case lag is occurring
	 */
	public static function newFromId( $rcid, $fromMaster = false ) {
		$db_id = $fromMaster ? DB_MASTER : DB_SLAVE;
		$dbr = wfGetDB( $db_id );
	 ...
	 */
	public static function markPatrolled( $change, $article = null ) {
		...
		wfRunHooks( 'MarkPatrolledDB', array(&$rcid, &$article) );
	}
