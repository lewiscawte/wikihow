...
/*
 * Function written by Travis. Takes a date and converts to format "Ago" format relative to
 * current date. 
 */
function wfTimeAgo($date) {
	// INTL: Use the internationalized time function based off the original wfTimeAgo
	return RCWidget::getDTDifferenceString($date);
}
