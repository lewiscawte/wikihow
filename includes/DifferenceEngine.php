...
CONTROL;
		...
		if ($this->mOldRev) {
			...
			$oldHeader = '<div id="mw-diff-otitle1"><h4>' . $prevlink . ' ' . $this->mOldtitle.'</h4></div>' .
			'<div id="mw-diff-otitle1a">' . $av . $this->mOldDate . '</div>' .
			'<div id="mw-diff-otitle2">by: ' . $sk->revUserTools( $this->mOldRev, true ) . "</div>";
			if($comment != "")
			    $oldHeader .= '<div id="mw-diff-otitle3" class="rccomment_top"><div class="rccomment_middle">' . $comment . '</div><div class="rccomment_bottom"></div></div>';
		} else {
		...
		$newHeader = '<div id="mw-diff-ntitle1"><h4>'.$this->mNewtitle . ' ' . $nextlink .  '</h4></div>' .
			'<div id="mw-diff-ntitle1a">' . $av . $this->mNewDate . '</div>' .
			'<div id="mw-diff-ntitle2">by: ' . $sk->revUserTools( $this->mNewRev, true ) . "</div>" .
			'<div id="mw-diff-ntitle2a">' . $rollback . "</div>" .
			'<div id="mw-diff-ntitle4">' . $nextlink . $patrol . '</div>';
		if($comment != "")
		    $newHeader .= '<div id="mw-diff-ntitle3" class="rccomment_top"><div class="rccomment_middle">' . $comment . '</div><div class="rccomment_bottom"></div></div>';
