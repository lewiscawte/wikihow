...
class PreferencesForm {
	...
	var $mThumbsNotifications, $mThumbsEmailNotifications;
	...
	function PreferencesForm( &$request ) {
		...
		if (class_exists('ThumbsUp')) {
			...
			//$this->mThumbsEmailNotifications = $request->getCheck( 'wpThumbsEmailNotifications' ) ? 1 : 0;
		}
	...
	function mainPrefsForm( $status , $message = '' ) {
		...
		if (class_exists('ThumbsUp')) {
			...
			//if ( $this->mThumbsEmailNotifications ) { $thumbs_email_checked = 'checked="checked"'; }
