...
class PreferencesForm {
	...
	//XXADDED
	//var $mUseAdvanced, $mIgnoreFanMail, $mScrollTalk, $mWysiwyg, $mMarketingEmailFlag, $mAuthorEmailNotifications;
	var $mUseAdvanced, $mIgnoreFanMail, $mScrollTalk, $mHidePersistantSaveBar, $mWysiwyg, $mMarketingEmailFlag, $mAuthorEmailNotifications, $mUserTalkNotifications;
	...
	function PreferencesForm( &$request ) {
        ...
        if ($wgUser->isAllowed('wysiwygtesting'))
			$this->mWysiwyg = $request->getVal('wpOpwysiwyg');
	...
	function savePreferences() {
        ...
        if ($wgUser->isAllowed('wysiwygtesting'))
			$wgUser->setOption( "wysiwyg", $this->mWysiwyg);
	...
	function resetPrefs() {
        ...
        if ($wgUser->isAllowed('wysiwygtesting'))
			$this->mWysiwyg= $wgUser->getOption('wysiwyg');
	...
	function mainPrefsForm( $status , $message = '' ) {
		...
		$options = wfMsg('pref_content_preferences_info') . "<br/><br/>"
			. Xml::radio('wpContentFilter', 0, $this->mContentFilter == 0) . " " . wfMsg('pref_content_preferences_all') . " <br/><br/>"
			. Xml::radio('wpContentFilter', 1, $this->mContentFilter == 1) . " " . wfMsg('pref_content_preferences_young') . " <br/><br/>"
			. Xml::radio('wpContentFilter', 2, $this->mContentFilter == 2) . " " . wfMsg('pref_content_preferences_adult') . " <br/><br/>"; 
		...
		if ( $wgEnableEmail ) {
			...
			if ($wgEnableUserEmail) {
				...
				//XXADDED Author emails
                                ...
                                $emailboxoptions = "<div style='border:2px solid #DDD;margin:3px 0 3px 0;padding:3px;'>$marketingEmail $usertalkEmail</div>\n";
			}
